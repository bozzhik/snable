...
export default function ImageCell({source, type, view}: Props) {
  ...
  return (
    <a href={source} className={cn('w-full h-20 rounded-lg bg-control/70', 'grid place-items-center overflow-hidden group', !isDetails && 'h-auto bg-unit-dark', isIcon && (!isDetails ? 'p-4' : 'p-0'))} target="_blank" onClick={handleClick}>
